...
public:
    ...
    void transformSPZ_RTZ9(eigen::vec_ar9_CMatPP_RM &nij, int nu_1) const {
        static const numerical::Real half = (numerical::Real).5;
...
private:
    // workspace
    inline static eigen::CMatPP_RM sTemp0;
    inline static eigen::CMatPP_RM sTemp1;
    inline static eigen::CMatPP_RM sTemp2;
    inline static eigen::CMatPP_RM sTemp3;
};
