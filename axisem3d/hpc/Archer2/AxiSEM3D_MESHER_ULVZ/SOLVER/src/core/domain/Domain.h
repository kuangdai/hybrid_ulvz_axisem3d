...
public:
    ...
    int addSolidPoint(SolidPoint *point);
    int addFluidPoint(FluidPoint *point);
    int addElement(Element *elem);
    int addSolidElement(SolidElement *elem);
    int addFluidElement(FluidElement *elem);
...
private:
    ...
    // points
    std::vector<SolidPoint *> mSolidPoints;
    std::vector<FluidPoint *> mFluidPoints;
    
    // elements
    std::vector<SolidElement *> mSolidElements;
    std::vector<FluidElement *> mFluidElements;
