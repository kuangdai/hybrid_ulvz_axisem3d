// SolverFFTW_1_nonstatic.cpp
// created by Kuangdai on 21-Apr-2016 
// perform FFT using fftw

#include "SolverFFTW_1_nonstatic.h"

void SolverFFTW_1_nonstatic::initialize(int Nmax) {
    int xx = 1;
    sNmax = Nmax;
...
void SolverFFTW_1_nonstatic::finalize() {
...
void SolverFFTW_1_nonstatic::computeR2C(int nr) {
...
void SolverFFTW_1_nonstatic::computeC2R(int nr) {
