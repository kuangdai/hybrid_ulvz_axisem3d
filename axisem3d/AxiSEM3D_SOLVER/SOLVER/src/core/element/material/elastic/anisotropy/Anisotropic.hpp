...
public:
    ...
    // stream constructor
    Anisotropic(sbs::ifstream &ifs):
    Elastic(ifs),
    mC11(ifs), mC12(ifs), mC13(ifs), mC14(ifs), mC15(ifs), mC16(ifs),
    mC22(ifs), mC23(ifs), mC24(ifs), mC25(ifs), mC26(ifs),
    mC33(ifs), mC34(ifs), mC35(ifs), mC36(ifs),
    mC44(ifs), mC45(ifs), mC46(ifs),
    mC55(ifs), mC56(ifs),
    mC66(ifs) {
        // nothing
    }
