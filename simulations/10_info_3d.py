...
if __name__ == "__main__":
    ...
    out_dir = Path(f'outputs/{run_name}/@@_info_3d')
    ...
    replace_in_file('templates/submit_mesh_info_3d.sh',
                    ...
                    dest=out_dir / 'submit_mesh_info_3d.sh')
